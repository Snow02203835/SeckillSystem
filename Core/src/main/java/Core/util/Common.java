...
public class Common {
     ...
     * @param code 原返回 ResponseCode
     * @return 修饰后的返回 Object
     */
    public static Object decorateResponseCode(ResponseCode code) {
        switch (code) {
            case RESOURCE_ID_NOT_EXIST:
                // 404：资源不存在
                return new ResponseEntity(
                        ResponseUtil.fail(code, code.getMessage()),
            ...
            case OK:
                return new ResponseEntity(
                    ...
                    HttpStatus.CREATED);
            default:
                return ResponseUtil.fail(code, code.getMessage());
        }
    }
